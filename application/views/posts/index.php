<?php if (!empty($posts)): ?>
    <?php foreach ($posts as $post): ?>
        <div class="post">
            <h3><a href="<?php echo base_url('posts/view/' . $post['id']); ?>"><?php echo htmlspecialchars($post['title']); ?></a></h3>
            ...
            <p><strong>Created:</strong> <?php echo date('F j, Y', strtotime($post['created_at'])); ?></p>
            <p><?php echo substr(htmlspecialchars($post['content']), 0, 200); ?><?php echo strlen($post['content']) > 200 ? '...' : ''; ?></p>
